...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/size-22KB-blue?style=flat&logo=size" alt="Size">
...
<p align="center">
  ...
  <a href="https://twitter.com/intent/tweet?text=Check+out+MINICAT+-+A+22KB+network+tool+42x+smaller+than+ncat&url=https%3A%2F%2Fgithub.com%2FAliZafar780%2FMINICAT">
...
**MINICAT** is a powerful, lightweight network tool built as a replacement for ncat (from nmap). At only **22KB**, it's **42x smaller** than ncat (945KB) while offering **MORE features**!
...
**Result: 42x smaller, 10x more connections, Zero dependencies!**
...
| Feature | Benefit |
|---------|---------|
| **22KB Size** | Fits on any device, ~100MB saved per Docker |
...
- 🚀 **Quick HTTP Servers** - 22KB vs nginx's 2MB+
...
|--------|------|---------|-------------|
| Binary Size | 945 KB | 22 KB | **42x smaller** |
